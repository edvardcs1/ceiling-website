...
export const TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    ...
    name: 'Sarah Jenkins',
    role: 'Homeowner',
    content: 'We had some major drywall damage after a leak. CM Acoustic repaired everything so well you can\'t even tell where the patch was. The texture match was perfect!',
    rating: 5,
  },
  {
    id: 't3',
